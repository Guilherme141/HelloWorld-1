...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22-Mar-2022 às 17:39
...
CREATE TABLE `tbturma` (
  ...
  `descTurma` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbturma` (`idTurma`, `siglaTurma`, `semestreTurma`, `idUsuario`, `nomeTurma`, `descTurma`) VALUES
(1, 'a', '2', 1, 'Banco de Dados', 'Turma de Banco'),
(2, 'b', '3', 1, 'Pw3', 'Turma de Pw3'),
(3, 'a', '2', 2, 'PTCC', 'Turma de TCC'),
(4, 'a &', '2', 3, 'Desenvolvimento de Sistemas', 'Turma de desenvolvimento de sistemas');
